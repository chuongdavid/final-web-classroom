  ...
  <head>
    ...
    <body class="signUp-body">
      ...
      <?php 
        $error = '';
        $message = '';
        if(isset($_GET['email']) && isset($_GET['id_teacher']) && isset($_GET['id_class'])){
          ...
          if(filter_var($email,FILTER_VALIDATE_EMAIL)==false){
            ...
            //check data base
            $data_teacher = $db -> fetchOne('user',"id = '".$id_teacher."'");
            $data_class = $db -> fetchOne('class',"id = '".$id_class."'");
            if(count($data_teacher)==0){
            ...
            elseif(count($data_class)==0){
              $error= ' Class not found ';
                ...
                if(isset($_POST['refuse'])){
                    $error =' Refuse to attend this class. ';
                }
            }
          }
        }
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-6 mt-5 mx-auto p-3 border rounded bg-light">
                  <h4>Invite to join in class from your teacher</h4>
                  <?php if(!empty($error)){
                      ?> 
