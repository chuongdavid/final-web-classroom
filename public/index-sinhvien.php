            ...
            <div class="classcard col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="cell">
                    ...
                    <div class="class-inf">
                        ...
                        <div class="sinhvien-title text-left ml-3 mt-0">
                            <img src="<?php echo base_url() ?>/public/uploads/class/<?php echo $item['image'] ?>" class="avatar" style="width:13%; border-radius: 50%"> <?php $item['teacher'] ?><?php echo $item['teacher'] ?>
                        </div>    
                            <a></a>    
                    </div>
    ...
    <div class="table-add-join-class-sinhvien col-12">  
        <form method="POST">
            <div class="formcode">
                ...
                <button class="btn btn-warning" type= "reset">Reset</button></br></br>
            </div> 
        </form>
    </div>
