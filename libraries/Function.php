...
function send_invitation_class($id_teacher,$id_class,$id_student,$email){
    $mail = new PHPMailer(true);
    try{
        //Server settings
        $mail->CharSet = 'utf-8';                      // Enable verbose debug output
        ...
        // Content
        $mail->isHTML(true);                                  // Set email format to HTML
        $mail->Subject = 'Your teacher invite you to join in this class';
        $mail->Body    = "<p><a href='".base_url()."/public/invitation_to_class.php?email=$email&id_teacher=$id_teacher&id_student=$id_student&id_class=$id_class'>Click here</a> to join in this class.</p>";
        // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
...
function send_notification($teacher_name,$class_name,$email){
    $mail = new PHPMailer(true);
    try{
        //Server settings
        $mail->CharSet = 'utf-8';                      // Enable verbose debug output
        ...
        // Content
        $mail->isHTML(true);                                  // Set email format to HTML
        $mail->Subject = 'You have a notification from your class';
        $mail->Body    = "<p>Teacher: $teacher_name have just posted an announcement in class: $class_name. <a href='".base_url()."/public/login.php'>Login</a> to check it out</p>";
        // $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
